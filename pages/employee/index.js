  ...
  return (
    <>
      <div className="container">
        <div className="card">
          <div className="card-header">ข้อมูลพนักงาน</div>
          <div className="card-body">
                  ...
                  <tr key={data.ID}>
                    ...
                    <td className="text-center">
                      <Link href={`/employee/edit/${data.ID}`}>
                        <a className="btn btn-warning btn-sm">แก้ไข</a>
                      </Link>
                    </td>
                    <td className="text-center">
                      <button
            ...
            <Link href="/employee/post">
              <a className="btn btn-success btn-sm text-right">
                เพิ่มข้อมูลพนักงาน
              </a>
            </Link>
          </div>
